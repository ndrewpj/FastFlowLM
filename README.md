...
> ⚠️ Ensure NPU driver is **32.0.203.258** or later (check via Task Manager → Performance → NPU or Device Manager) — [AMD Driver Download](https://www.amd.com/en/support).
